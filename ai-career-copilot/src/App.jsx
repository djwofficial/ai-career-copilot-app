...
function Dashboard({ go = () => {}, mini = false, noNav = false }) {
  const agentUpdates = [
    {
      id: 1,
      time: "09:30",
  ...
  return (
    <Screen nav={!mini && !noNav} floatingNav={noNav} go={go} activeTab="home">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 rounded-2xl border border-[#d1d3d2] bg-[#ffffff] p-2 pl-4 shadow-sm focus-within:border-[#000100] focus-within:ring-1 focus-within:ring-[#000100]">
          <input
            type="text"
            placeholder="Set your agent goals..."
      ...
      <Screen>
        <div className="sticky top-0 z-50 -mx-6 -mt-8 mb-4 flex items-center justify-between bg-transparent px-6 pb-3 pt-14 ">
          ...
          <div className="min-w-0 flex-1 px-3 text-center">
            <h1 className="truncate text-base font-bold text-[#000100]">
              Resume Preview
            </h1>
